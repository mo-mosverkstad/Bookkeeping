...
// Canonical location: test/plugins/geometry/grammar.test.ts
// Hosted here due to WSL DrvFs dentry cache constraint (see docs/exception.md):
// test files in directories created from Windows are invisible to WSL's Node.js.
